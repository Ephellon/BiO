...
WebInspector.CookiesTable.prototype = {
  ...
  _sortCookies: function (cookies) {
    ...
    case "secure":
      ...
      break;
    case "sameSite":
      comparator = compareTo.bind(null, WebInspector.Cookie.prototype.sameSite);
      break;
    default:
...
WebInspector.FilmStripView.prototype = {
  ...
  update: function () {
    ...
    this.createFrameElement(frames[0]).then(continueWhenFrameImageLoaded.bind(this));
