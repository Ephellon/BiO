...
WebInspector.ProfileView = function (nodeFormatter, viewTypes) {
  ...
  viewTypes = viewTypes || [WebInspector.ProfileView.ViewTypes.Flame, WebInspector.ProfileView.ViewTypes.Heavy, WebInspector.ProfileView.ViewTypes.Tree];
  ...
  var optionNames = new Map([[WebInspector.ProfileView.ViewTypes.Flame, WebInspector.UIString("Chart")], [WebInspector.ProfileView.ViewTypes.Heavy, WebInspector.UIString("Heavy (Bottom Up)")], [WebInspector.ProfileView.ViewTypes.Tree, WebInspector.UIString("Tree (Top Down)")], ]);
...
WebInspector.CPUProfileType.prototype = {
  ...
  _consoleProfileFinished: function (event) {
    var data = (event.data);
    var cpuProfile = (data.cpuProfile);
    var resolvedTitle = data.title;
  ...
  _addMessageToConsole: function (type, scriptLocation, messageText) {
    ...
    var message = new WebInspector.ConsoleMessage(target, WebInspector.ConsoleMessage.MessageSource.ConsoleAPI, WebInspector.ConsoleMessage.MessageLevel.Debug, messageText, type, undefined, undefined, undefined, undefined, [{
      functionName: "",
...
WebInspector.HeapProfileView = function (profileHeader) {
  ...
  var views = [WebInspector.ProfileView.ViewTypes.Flame, WebInspector.ProfileView.ViewTypes.Heavy, WebInspector.ProfileView.ViewTypes.Tree];
...
WebInspector.SamplingHeapProfileType.prototype = {
  ...
  stopRecordingProfile: function () {
    ...
    this._profileBeingRecorded.target().heapProfilerModel.stopSampling().then(didStopProfiling.bind(this)).then(WebInspector.targetManager.resumeAllTargets.bind(WebInspector.targetManager)).then(fireEvent.bind(this));
  },
  createProfileLoadedFromFile: function (title) {
